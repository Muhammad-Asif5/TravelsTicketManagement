...
namespace AMS.App_Start
{
    public class EmailService : IIdentityMessageService
    {
        ...
        void sendMail(IdentityMessage message)
        {
            ...
            msg.AlternateViews.Add(AlternateView.CreateAlternateViewFromString(html1, null, MediaTypeNames.Text.Html));
            msg.IsBodyHtml = true;

            SmtpClient smtpClient = new SmtpClient("smtp.gmail.com", Convert.ToInt32(587));
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("muhammadasifgondal@gmail.com",
               "355619401102686");
