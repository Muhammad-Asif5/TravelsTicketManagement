        ...
        var ajaxConfig = {
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    var temp = table.row(index[0]).data();
                    temp[1] = oForm["Cust_Code"].value;
                    temp[2] = oForm["Company_Name"].value;
                    temp[3] = oForm["Lookup"].value;
                    temp[4] = oForm["Contact_Name"].value;
                    temp[5] = oForm["Address"].value;
                    temp[6] = oForm["City"].value;
                    temp[7] = oForm["State"].value;
                    temp[8] = oForm["ZIP_Code"].value;
                    temp[9] = oForm["Phone"].value;
                    temp[10] = oForm["Email"].value;
                    temp[11] = oForm["Fax"].value;
...
$(function () {
    $("#myTable").DataTable({
        ...
        // "orderable": false,
        "columnDefs": [
            { "targets": [0], "orderable": false, width: 250 },
