...
function OnSuccess(response) {
    ...
    if (response.success == true) {
        table = $("#myTable").DataTable(
            {
                ...
                "language": {
                    ...
                    "zeroRecords": "No <b>Unpaid Invoice</b> Data Found",
                    //"info": "Total",
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        messageTop: 'Horizon Account Management System, Unpaid Invoice Report',
        ...
        $('.dataTables_filter input').attr("placeholder", "Search Unpaid Invoice");
